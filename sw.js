const SHELL_CACHE='aps-rounds-shell-v1.4.0';
const RUNTIME_CACHE='aps-rounds-runtime-v1.4.0';
const SHELL=[
  './','./index.html','./app.css','./optimistic-sync.js','./app.js','./manifest.webmanifest',
